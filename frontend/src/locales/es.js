...
export default {
  ...
  'Build a routine with AI': 'Crea una rutina con IA',
  'Get a prompt for ChatGPT, Claude or any AI, then paste its answer back to import the plan. You run the AI yourself — nothing leaves your device.': 'Obtén un prompt para ChatGPT, Claude o cualquier IA, y pega su respuesta aquí para importar el plan. Tú ejecutas la IA — nada sale de tu dispositivo.',
  'Get an AI prompt': 'Obtener un prompt de IA',
  'Import from AI': 'Importar desde IA',
  'AI plan prompt': 'Prompt para plan con IA',
  'Copy this into any AI and edit the “My details” lines. It replies with a plan — then come back and use “Import from AI”.': 'Copia esto en cualquier IA y edita las líneas de «My details». Te responderá con un plan; vuelve y usa «Importar desde IA».',
  'Copy prompt': 'Copiar prompt',
  'Prompt copied': 'Prompt copiado',
  'Couldn’t copy — select the text and copy it': 'No se pudo copiar: selecciona el texto y cópialo',
  'Share…': 'Compartir…',
  'Paste the AI’s reply — the JSON plan from the prompt. Extra text around it is fine.': 'Pega la respuesta de la IA: el plan en JSON del prompt. No pasa nada si hay texto alrededor.',
  'Paste the AI’s answer…': 'Pega la respuesta de la IA…',
  'Read plan': 'Leer plan',
  'Couldn’t read that: {0}': 'No se pudo leer: {0}',
  '{0} exercise wasn’t in the library — added as your own.': '{0} ejercicio no estaba en la biblioteca; se añadió como propio.',
  '{0} exercises weren’t in the library — added as your own.': '{0} ejercicios no estaban en la biblioteca; se añadieron como propios.',
  'AI routine': 'Rutina de IA',
  'paste the AI’s reply first': 'pega primero la respuesta de la IA',
  ...
  "Add an exercise to a routine first — there’s nothing to sign yet.": "Primero añade un ejercicio a una rutina — aún no hay nada que firmar.",
  "Add logo": "Añadir logo",
  "Add report": "Añadir reporte",
  "Back up my recovery code": "Respaldar mi código de recuperación",
  "Become a coach": "Hacerme coach",
  "Brand name shown to clients": "Nombre de marca que ven los clientes",
  ...
  "Couldn’t build the report: {0}": "No se pudo generar el reporte: {0}",
  "Couldn’t create the identity: {0}": "No se pudo crear la identidad: {0}",
  "Couldn’t open that report — is it for you?": "No se pudo abrir ese reporte — ¿es para ti?",
  "Couldn’t read that file": "No se pudo leer ese archivo",
  "Couldn’t sign the plan: {0}": "No se pudo firmar el plan: {0}",
  "Create and sign plans for your clients": "Crea y firma planes para tus clientes",
  "Create encrypted report": "Crear reporte cifrado",
  "Create my coach identity": "Crear mi identidad de coach",
  "Creates your coach identity on this device — a key that signs the plans you send, and a code your clients pair with. Keep the recovery code safe: it’s the only way to restore this identity.": "Crea tu identidad de coach en este dispositivo — una llave que firma los planes que envías y un código con el que se emparejan tus clientes. Guarda bien el código de recuperación: es la única forma de restaurar esta identidad.",
  "Creating…": "Creando…",
  "Encrypted report ready to send": "Reporte cifrado listo para enviar",
  "I have a coach": "Tengo un coach",
  "Import a client report": "Importar un reporte de cliente",
  "Import a plan from my coach": "Importar un plan de mi coach",
  "I’m a coach": "Soy coach",
  "Logo is too big — pick one under 400 KB": "El logo es muy grande — elige uno menor a 400 KB",
  "My clients": "Mis clientes",
  "My clients ({0})": "Mis clientes ({0})",
  "My coach": "Mi coach",
  "Plan from your coach": "Plan de tu coach",
  "Read-only so it stays exactly as {0} prescribed it.": "Solo lectura, para que quede exactamente como {0} lo indicó.",
  "your coach": "tu coach",
  "My coach: {0}": "Mi coach: {0}",
  "No client reports yet. Ask a client to send you one from “My coach”.": "Aún no hay reportes de clientes. Pídele a un cliente que te envíe uno desde «Mi coach».",
  "Not verified: {0}": "No verificado: {0}",
  "Only your coach can open it. Your full history stays on your device.": "Solo tu coach puede abrirlo. Tu historial completo se queda en tu dispositivo.",
  "Open coach card": "Abrir tarjeta del coach",
  "Open the coach card your trainer sent you. After pairing, their plans verify automatically and your reports go only to them.": "Abre la tarjeta de coach que te envió tu entrenador. Tras emparejarte, sus planes se verifican solos y tus reportes van solo a él.",
  "Pair to get verified plans": "Empareja para recibir planes verificados",
  "Pair with your coach": "Emparéjate con tu coach",
  "Paired with {0}": "Emparejado con {0}",
  "Remove": "Quitar",
  "Report from {0} imported": "Reporte de {0} importado",
  "Save PDF": "Guardar PDF",
  "Save brand": "Guardar marca",
  "Send a progress report": "Enviar un reporte de progreso",
  "Send this to a client once so they can pair with you and verify your plans.": "Envía esto una vez a un cliente para que se empareje contigo y verifique tus planes.",
  "Sessions": "Sesiones",
  "Share my coach card": "Compartir mi tarjeta de coach",
  "Sign & share a plan": "Firmar y compartir un plan",
  "Sign routines only": "Firmar solo las rutinas",
  "Sign with weekly schedule": "Firmar con horario semanal",
  "Signed plan ready to send": "Plan firmado listo para enviar",
  "Signs your current routines as a plan only this client can trust came from you — and that they can’t edit undetected. Build the plan in your own Plan tab first.": "Firma tus rutinas actuales como un plan que este cliente sabe que viene de ti — y que no puede editar sin que se note. Arma el plan antes en tu pestaña Plan.",
  "That plan isn’t signed — import it from Plan tools instead": "Ese plan no está firmado — impórtalo desde las herramientas de Plan",
  "That’s not a coach card": "Eso no es una tarjeta de coach",
  "Top lifts": "Mejores levantamientos",
  "Unpair from this coach": "Desvincularme de este coach",
  "Unpaired from your coach": "Te desvinculaste de tu coach",
  "Verified as really from your coach, and flagged if it was tampered with.": "Verificado como realmente de tu coach, y marcado si fue alterado.",
  "Verified plan from {0} imported": "Plan verificado de {0} importado",
  "Weight": "Peso",
  "Your brand": "Tu marca",
  "Your brand (white-label)": "Tu marca (marca blanca)",
  "Your clients see this on the plans and card you send — your logo, colour and name.": "Tus clientes ven esto en los planes y la tarjeta que envías — tu logo, color y nombre.",
  "Your coach": "Tu coach",
  "Your coach code": "Tu código de coach",
  "Your coach name (optional)": "Tu nombre de coach (opcional)",
  "Your name (so your coach knows who it is)": "Tu nombre (para que tu coach sepa quién eres)",
  "You’re set up as a coach": "Ya estás configurado como coach",
  "a client": "un cliente"
}
