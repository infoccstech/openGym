...
export default {
  ...
  'Unpair': 'Ayır',
  "Find alternatives": "Alternatif bul",
  "Alternatives for “{0}”": "“{0}” için alternatifler",
  "Same muscle, other options — pick what your gym, and your body, allow today.": "Aynı kas, farklı seçenekler — bugün salonunun ve vücudunun izin verdiğini seç.",
  "Equipment you can use": "Kullanabileceğin ekipman",
  "Sore muscle? Leave it out": "Ağrıyan kas mı? Onu dışarıda bırak",
  "Sharp or joint pain isn’t normal soreness — stop and get it checked. This isn’t medical advice.": "Keskin ya da eklem ağrısı normal kas ağrısı değildir — dur ve kontrol ettir. Bu tıbbi tavsiye değildir.",
  "No alternatives match those filters — loosen them a little.": "Bu filtrelere uyan alternatif yok — biraz gevşet.",
  "Swap exercise": "Egzersizi değiştir",
  "Swapped to {0}": "{0} ile değiştirildi",
  "Build a routine with AI": "Yapay zekâ ile rutin oluştur",
  "Get a prompt for ChatGPT, Claude or any AI, then paste its answer back to import the plan. You run the AI yourself — nothing leaves your device.": "ChatGPT, Claude ya da herhangi bir yapay zekâ için bir istem al, sonra planı içe aktarmak için cevabını buraya yapıştır. Yapay zekâyı sen çalıştırırsın — hiçbir şey cihazından çıkmaz.",
  "Get an AI prompt": "Yapay zekâ istemi al",
  "Import from AI": "Yapay zekâdan içe aktar",
  "AI plan prompt": "Yapay zekâ plan istemi",
  "Copy this into any AI and edit the “My details” lines. It replies with a plan — then come back and use “Import from AI”.": "Bunu herhangi bir yapay zekâya kopyala ve “My details” satırlarını düzenle. Bir planla yanıt verir — sonra geri dön ve “Yapay zekâdan içe aktar”ı kullan.",
  "Copy prompt": "İstemi kopyala",
  "Prompt copied": "İstem kopyalandı",
  "Couldn’t copy — select the text and copy it": "Kopyalanamadı — metni seçip kopyala",
  "Share…": "Paylaş…",
  "Paste the AI’s reply — the JSON plan from the prompt. Extra text around it is fine.": "Yapay zekânın yanıtını yapıştır — istemdeki JSON plan. Etrafındaki fazladan metin sorun değil.",
  "Paste the AI’s answer…": "Yapay zekânın yanıtını yapıştır…",
  "Read plan": "Planı oku",
  "Couldn’t read that: {0}": "Bu okunamadı: {0}",
  "{0} exercise wasn’t in the library — added as your own.": "{0} egzersiz kütüphanede yoktu — kendi egzersizin olarak eklendi.",
  "{0} exercises weren’t in the library — added as your own.": "{0} egzersiz kütüphanede yoktu — kendi egzersizlerin olarak eklendi.",
  "AI routine": "Yapay zekâ rutini",
  "paste the AI’s reply first": "önce yapay zekânın yanıtını yapıştır",
  "couldn’t find a plan in that text": "o metinde bir plan bulunamadı",
  "that isn’t valid JSON — copy the AI’s whole reply": "bu geçerli JSON değil — yapay zekânın tüm yanıtını kopyala",
  "that plan has no routines": "bu planda hiç rutin yok",
  "that plan has no exercises": "bu planda hiç egzersiz yok",
  "Back up to cloud": "Buluta yedekle",
  "Send it to Google Drive, Files, email…": "Google Drive, Dosyalar, e-postaya gönder…",
  "Add an exercise to a routine first — there’s nothing to sign yet.": "Önce bir rutine egzersiz ekle — henüz imzalanacak bir şey yok.",
  "Add logo": "Logo ekle",
  "Add report": "Rapor ekle",
  "Back up my recovery code": "Kurtarma kodumu yedekle",
  "Become a coach": "Koç ol",
  "Brand name shown to clients": "Danışanların gördüğü marka adı",
  "Brand saved": "Marka kaydedildi",
  "Change logo": "Logoyu değiştir",
  "Client": "Danışan",
  "Client name (optional)": "Danışan adı (isteğe bağlı)",
  "Coach": "Koç",
  "Coach dashboard": "Koç paneli",
  "Couldn’t build the report: {0}": "Rapor oluşturulamadı: {0}",
  "Couldn’t create the identity: {0}": "Kimlik oluşturulamadı: {0}",
  "Couldn’t open that report — is it for you?": "Bu rapor açılamadı — sana mı ait?",
  "Couldn’t read that file": "Bu dosya okunamadı",
  "Couldn’t sign the plan: {0}": "Plan imzalanamadı: {0}",
  "Create and sign plans for your clients": "Danışanların için plan oluştur ve imzala",
  "Create encrypted report": "Şifreli rapor oluştur",
  "Create my coach identity": "Koç kimliğimi oluştur",
  "Creates your coach identity on this device — a key that signs the plans you send, and a code your clients pair with. Keep the recovery code safe: it’s the only way to restore this identity.": "Koç kimliğini bu cihazda oluşturur — gönderdiğin planları imzalayan bir anahtar ve danışanlarının eşleştiği bir kod. Kurtarma kodunu güvende tut: bu kimliği geri yüklemenin tek yolu budur.",
  "Creating…": "Oluşturuluyor…",
  "Encrypted report ready to send": "Şifreli rapor gönderilmeye hazır",
  "I have a coach": "Bir koçum var",
  "Import a client report": "Danışan raporu içe aktar",
  "Import a plan from my coach": "Koçumdan bir plan içe aktar",
  "I’m a coach": "Ben koçum",
  "Logo is too big — pick one under 400 KB": "Logo çok büyük — 400 KB altında bir tane seç",
  "My clients": "Danışanlarım",
  "My clients ({0})": "Danışanlarım ({0})",
  "My coach": "Koçum",
  "Plan from your coach": "Koçundan gelen plan",
  "Read-only so it stays exactly as {0} prescribed it.": "Salt okunur, böylece tam olarak {0} nasıl belirlediyse öyle kalır.",
  "your coach": "koçun",
  "My coach: {0}": "Koçum: {0}",
  "No client reports yet. Ask a client to send you one from “My coach”.": "Henüz danışan raporu yok. Bir danışandan “Koçum” bölümünden sana bir tane göndermesini iste.",
  "Not verified: {0}": "Doğrulanmadı: {0}",
  "Only your coach can open it. Your full history stays on your device.": "Sadece koçun açabilir. Tüm geçmişin cihazında kalır.",
  "Open coach card": "Koç kartını aç",
  "Open the coach card your trainer sent you. After pairing, their plans verify automatically and your reports go only to them.": "Antrenörünün gönderdiği koç kartını aç. Eşleştikten sonra planları otomatik doğrulanır ve raporların yalnızca ona gider.",
  "Pair to get verified plans": "Doğrulanmış plan almak için eşleş",
  "Pair with your coach": "Koçunla eşleş",
  "Paired with {0}": "{0} ile eşleşildi",
  "Remove": "Kaldır",
  "Report from {0} imported": "{0} kişisinin raporu içe aktarıldı",
  "Save PDF": "PDF kaydet",
  "Save brand": "Markayı kaydet",
  "Send a progress report": "İlerleme raporu gönder",
  "Send this to a client once so they can pair with you and verify your plans.": "Bunu bir danışana bir kez gönder ki seninle eşleşip planlarını doğrulayabilsin.",
  "Sessions": "Seanslar",
  "Share my coach card": "Koç kartımı paylaş",
  "Sign & share a plan": "Bir planı imzala ve paylaş",
  "Sign routines only": "Yalnızca rutinleri imzala",
  "Sign with weekly schedule": "Haftalık programla imzala",
  "Signed plan ready to send": "İmzalı plan gönderilmeye hazır",
  "Signs your current routines as a plan only this client can trust came from you — and that they can’t edit undetected. Build the plan in your own Plan tab first.": "Mevcut rutinlerini, bu danışanın senden geldiğine güvenebileceği ve fark edilmeden düzenleyemeyeceği bir plan olarak imzalar. Önce planı kendi Plan sekmende oluştur.",
  "That plan isn’t signed — import it from Plan tools instead": "Bu plan imzalı değil — bunun yerine Plan araçlarından içe aktar",
  "That’s not a coach card": "Bu bir koç kartı değil",
  "Top lifts": "En iyi kaldırışlar",
  "Unpair from this coach": "Bu koçtan eşleşmeyi kaldır",
  "Unpaired from your coach": "Koçundan eşleşme kaldırıldı",
  "Verified as really from your coach, and flagged if it was tampered with.": "Gerçekten koçundan geldiği doğrulandı ve değiştirildiyse işaretlendi.",
  "Verified plan from {0} imported": "{0} kişisinin doğrulanmış planı içe aktarıldı",
  "Weight": "Ağırlık",
  "Your brand": "Markan",
  "Your brand (white-label)": "Markan (beyaz etiket)",
  "Your clients see this on the plans and card you send — your logo, colour and name.": "Danışanların bunu gönderdiğin planlarda ve kartta görür — logon, rengin ve adın.",
  "Your coach": "Koçun",
  "Your coach code": "Koç kodun",
  "Your coach name (optional)": "Koç adın (isteğe bağlı)",
  "Your name (so your coach knows who it is)": "Adın (koçunun kim olduğunu bilmesi için)",
  "You’re set up as a coach": "Koç olarak ayarlandın",
  "a client": "bir danışan"
}
