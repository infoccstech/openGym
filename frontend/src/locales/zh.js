...
export default {
  ...
  'Unpair': '取消组合',
  "Find alternatives": "寻找替代动作",
  "Alternatives for “{0}”": "“{0}” 的替代动作",
  "Same muscle, other options — pick what your gym, and your body, allow today.": "同一块肌肉，其他选择——挑选今天你的健身房和身体允许的动作。",
  "Equipment you can use": "你可用的器械",
  "Sore muscle? Leave it out": "肌肉酸痛？把它排除",
  "Sharp or joint pain isn’t normal soreness — stop and get it checked. This isn’t medical advice.": "剧烈疼痛或关节疼痛不是普通的酸痛——请停下并就医检查。这不是医疗建议。",
  "No alternatives match those filters — loosen them a little.": "没有符合这些筛选的替代动作——放宽一点。",
  "Swap exercise": "替换动作",
  "Swapped to {0}": "已替换为 {0}",
  "Build a routine with AI": "用 AI 生成计划",
  "Get a prompt for ChatGPT, Claude or any AI, then paste its answer back to import the plan. You run the AI yourself — nothing leaves your device.": "获取一段给 ChatGPT、Claude 或任意 AI 的提示词，然后把它的回复粘贴回来即可导入计划。AI 由你自己运行——没有任何数据离开你的设备。",
  "Get an AI prompt": "获取 AI 提示词",
  "Import from AI": "从 AI 导入",
  "AI plan prompt": "AI 计划提示词",
  "Copy this into any AI and edit the “My details” lines. It replies with a plan — then come back and use “Import from AI”.": "把这段复制到任意 AI，并修改 “My details” 各行。它会回复一份计划——然后回来使用 “从 AI 导入”。",
  "Copy prompt": "复制提示词",
  "Prompt copied": "提示词已复制",
  "Couldn’t copy — select the text and copy it": "无法复制——请选中文本并复制",
  "Share…": "分享…",
  "Paste the AI’s reply — the JSON plan from the prompt. Extra text around it is fine.": "粘贴 AI 的回复——提示词里的 JSON 计划。周围有多余文字也没关系。",
  "Paste the AI’s answer…": "粘贴 AI 的回复…",
  "Read plan": "读取计划",
  "Couldn’t read that: {0}": "无法读取：{0}",
  "{0} exercise wasn’t in the library — added as your own.": "{0} 个动作不在动作库中——已添加为你自己的动作。",
  "{0} exercises weren’t in the library — added as your own.": "{0} 个动作不在动作库中——已添加为你自己的动作。",
  "AI routine": "AI 计划",
  "paste the AI’s reply first": "请先粘贴 AI 的回复",
  "couldn’t find a plan in that text": "在这段文字里找不到计划",
  "that isn’t valid JSON — copy the AI’s whole reply": "这不是有效的 JSON——请复制 AI 的完整回复",
  "that plan has no routines": "该计划没有任何训练",
  "that plan has no exercises": "该计划没有任何动作",
  "Back up to cloud": "备份到云端",
  "Send it to Google Drive, Files, email…": "发送到 Google Drive、文件、电子邮件…",
  "Add an exercise to a routine first — there’s nothing to sign yet.": "请先在某个训练计划中添加动作——现在还没有可签名的内容。",
  "Add logo": "添加标志",
  "Add report": "添加报告",
  "Back up my recovery code": "备份我的恢复码",
  "Become a coach": "成为教练",
  "Brand name shown to clients": "客户看到的品牌名称",
  "Brand saved": "品牌已保存",
  "Change logo": "更换标志",
  "Client": "客户",
  "Client name (optional)": "客户姓名（可选）",
  "Coach": "教练",
  "Coach dashboard": "教练面板",
  "Couldn’t build the report: {0}": "无法生成报告：{0}",
  "Couldn’t create the identity: {0}": "无法创建身份：{0}",
  "Couldn’t open that report — is it for you?": "无法打开该报告——是给你的吗？",
  "Couldn’t read that file": "无法读取该文件",
  "Couldn’t sign the plan: {0}": "无法为该计划签名：{0}",
  "Create and sign plans for your clients": "为你的客户创建并签名计划",
  "Create encrypted report": "创建加密报告",
  "Create my coach identity": "创建我的教练身份",
  "Creates your coach identity on this device — a key that signs the plans you send, and a code your clients pair with. Keep the recovery code safe: it’s the only way to restore this identity.": "在本设备上创建你的教练身份——一个为你发送的计划签名的密钥，以及客户与之配对的代码。请妥善保管恢复码：这是恢复此身份的唯一方式。",
  "Creating…": "创建中…",
  "Encrypted report ready to send": "加密报告已可发送",
  "I have a coach": "我有教练",
  "Import a client report": "导入客户报告",
  "Import a plan from my coach": "从我的教练导入计划",
  "I’m a coach": "我是教练",
  "Logo is too big — pick one under 400 KB": "标志太大——请选择小于 400 KB 的",
  "My clients": "我的客户",
  "My clients ({0})": "我的客户（{0}）",
  "My coach": "我的教练",
  "Plan from your coach": "来自你教练的计划",
  "Read-only so it stays exactly as {0} prescribed it.": "只读，以保持与 {0} 所开方案完全一致。",
  "your coach": "你的教练",
  "My coach: {0}": "我的教练：{0}",
  "No client reports yet. Ask a client to send you one from “My coach”.": "暂无客户报告。让客户从“我的教练”给你发送一份。",
  "Not verified: {0}": "未验证：{0}",
  "Only your coach can open it. Your full history stays on your device.": "只有你的教练能打开它。你的完整历史保留在你的设备上。",
  "Open coach card": "打开教练名片",
  "Open the coach card your trainer sent you. After pairing, their plans verify automatically and your reports go only to them.": "打开教练发给你的名片。配对后，他的计划会自动验证，你的报告也只发给他。",
  "Pair to get verified plans": "配对以获取已验证的计划",
  "Pair with your coach": "与你的教练配对",
  "Paired with {0}": "已与 {0} 配对",
  "Remove": "移除",
  "Report from {0} imported": "已导入 {0} 的报告",
  "Save PDF": "保存 PDF",
  "Save brand": "保存品牌",
  "Send a progress report": "发送进度报告",
  "Send this to a client once so they can pair with you and verify your plans.": "把它发给客户一次，客户就能与你配对并验证你的计划。",
  "Sessions": "训练次数",
  "Share my coach card": "分享我的教练名片",
  "Sign & share a plan": "签名并分享计划",
  "Sign routines only": "仅签名训练计划",
  "Sign with weekly schedule": "连同每周安排一起签名",
  "Signed plan ready to send": "已签名的计划可发送",
  "Signs your current routines as a plan only this client can trust came from you — and that they can’t edit undetected. Build the plan in your own Plan tab first.": "将你当前的训练计划签名为一个计划，客户能确信它来自你，且无法在不被察觉的情况下修改。请先在你自己的“计划”标签中构建计划。",
  "That plan isn’t signed — import it from Plan tools instead": "该计划未签名——请改用“计划”工具导入",
  "That’s not a coach card": "那不是教练名片",
  "Top lifts": "最佳成绩",
  "Unpair from this coach": "取消与该教练的配对",
  "Unpaired from your coach": "已取消与教练的配对",
  "Verified as really from your coach, and flagged if it was tampered with.": "已验证确实来自你的教练；若被篡改会被标记。",
  "Verified plan from {0} imported": "已导入 {0} 的已验证计划",
  "Weight": "体重",
  "Your brand": "你的品牌",
  "Your brand (white-label)": "你的品牌（白标）",
  "Your clients see this on the plans and card you send — your logo, colour and name.": "客户会在你发送的计划和名片上看到它——你的标志、颜色和名称。",
  "Your coach": "你的教练",
  "Your coach code": "你的教练代码",
  "Your coach name (optional)": "你的教练名称（可选）",
  "Your name (so your coach knows who it is)": "你的名字（让教练知道是谁）",
  "You’re set up as a coach": "你已设置为教练",
  "a client": "一位客户"
}
